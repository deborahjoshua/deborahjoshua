...
I build structured, insight-driven dashboards using Power BI, SQL, and Excel to transform raw data into decision-support intelligence.
...
- Time-Based Comparative Analysis (YoY, MoM)
...
## 🛠 Tools & Technologies
- Power BI (DAX Measures, Data Modeling, Power Query)
...
- ER Dashboard: https://youtu.be/zTTw7P4ZN4g  
- Superstore Sales Dashboard: https://youtu.be/YjMh8wVxksQ  
